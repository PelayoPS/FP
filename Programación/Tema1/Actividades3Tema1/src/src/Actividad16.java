...
public class Actividad16 {
    ...
    public static void main(String[] args) {
        /*
         * Dada una hora por teclado (horas, minutos y segundos) realizar una
         * función que muestre la hora después de incrementar un segundo.
         */
    ...
    private static void incrementaSegundo(String time) {
